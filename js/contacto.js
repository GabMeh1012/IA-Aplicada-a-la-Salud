...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var campos = {
    ...
    telefono: {
      ...
      validar: function (valor) {
        ...
        if (soloDigitos.length < 7 || soloDigitos.length > 8) return "Debe tener entre 7 y 8 dígitos.";
        return "";
      }
    },
    tipoConsulta: {
      ...
      validar: function (valor) {
        if (!valor) return "Selecciona un tipo de consulta.";
        return "";
      }
    },
    mensaje: {
  ...
  form.addEventListener("submit", function (evento) {
    ...
    var registro = {
      ...
      tipoConsulta: campos.tipoConsulta.input.value,
